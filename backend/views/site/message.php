        ...
        <ul>
          <li class="contact active">
            <div class="wrap">
              ...
              <img src="<?= $image_url . "/profile/uploads/" . Yii::$app->user->identity->image_url ?>" alt="" style="width:50px;height:50px;object-fit:cover;"></>
              <div class="meta">
      ...
      <div class="messages">
        <ul>
          ...
          ?>
              ...
              ?>
                <li class="sent">
                  <img src="<?= $image_url . "/profile/uploads/" . Yii::$app->user->identity->image_url ?>" alt="" style="width:30px;height:30px;object-fit:cover;"></>
                  <p><?= $value->content ?></p>
                </li>
